        ...
        {!showVerificationMessage && (
          ...
          <div className="pt-4">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-1xl shadow-sm bg-white text-sm font-medium text-[#4a5a3f] hover:bg-gray-50 transition-colors cursor-pointer"
              >
