            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Gestiona tu tienda de manera eficiente con las herramientas disponibles
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                    <div className="w-10 h-10 bg-[#4a5a3f]/10 rounded-lg flex items-center justify-center">
                      <svg className="w-5 h-5 text-[#4a5a3f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                      </svg>
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Base de datos real</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                    <div className="w-10 h-10 bg-[#4a5a3f]/10 rounded-lg flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Analytics reales</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="hidden lg:block">
                <div className="w-24 h-24 bg-[#4a5a3f]/5 rounded-xl flex items-center justify-center">
                  <svg className="w-12 h-12 text-[#4a5a3f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
